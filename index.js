...
const GameIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        {
            case 'headtail':
                speakOutput+="you said head and and it comes out to be tail, you lost ! ";
                break;
            case 'headhead':
                speakOutput+="you said head and and it comes out to be head, you win! ";
                break;
           case 'tailhead':
                speakOutput+="you said tail and and it comes out to be head, you lost! ";
                break;
                case 'tailtail':
                speakOutput+="you said tail and and it comes out to be tail, you win! ";
                break;
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'This is a skill to toss a coin. What do you choose?';
